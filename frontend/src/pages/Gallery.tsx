...
function Gallery() {
    ...
    let data1 =[
        {id: 1, imgSrc: env_img1,}, {id: 2, imgSrc: env_img2,}, {id: 3, imgSrc: env_img3,}, {id: 4, imgSrc: env_img4,}, {id: 5, imgSrc: env_img5,
        }, {id: 6, imgSrc: env_img6,}, {id: 7, imgSrc: env_img7,}, {id: 8, imgSrc: env_img8,}, {id: 9, imgSrc: env_img9,},
    ]
    let data2 =[
        {id: 1, imgSrc: act_img1,}, {id: 2, imgSrc: act_img2,}, {id: 3, imgSrc: act_img3,}, {id: 4, imgSrc: act_img4,}, {id: 5, imgSrc: act_img5,
        }, {id: 6, imgSrc: act_img6,}, {id: 7, imgSrc: act_img7,}, {id: 8, imgSrc: act_img8,}, {id: 9, imgSrc: act_img9,}, {id: 10, imgSrc: act_img10,},
        {id: 11, imgSrc: act_img11,}, {id: 12, imgSrc: act_img12,}, {id: 13, imgSrc: act_img13,}, {id: 14, imgSrc: act_img14,}, {id: 15, imgSrc: act_img15,},
        {id: 16, imgSrc: act_img16,}, {id: 17, imgSrc: act_img17,}, {id: 18, imgSrc: act_img18,}, {id: 19, imgSrc: act_img19,}, {id: 20, imgSrc: act_img20,},
    ]
  ...
  return (
    <ApplicationStructure>
        ...
        <h4 style={{ textAlign: 'left' }}>Discover the vibrant atmosphere, supportive environment, and engaging activities that make our elderly daycare center a special place to be. </h4>

            <h3 className="section-heading" style={{ textAlign: 'left' }}>Our Environment</h3>
        ...
        <div className="gallery-section2">
            <div className="parent-container">
                <h3 className="section-heading" style={{ textAlign: 'left' }}>Activities</h3>
                <h4>Take a look at the engaging activities we offer, from group exercises to creative arts, that bring joy and connection to our residents.</h4>
                <div className="gallery">
